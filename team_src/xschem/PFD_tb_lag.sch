...
C {vsource.sym} -450 -30 0 0 {name=V_REF value="PULSE(0 3.3 150n 100p 100p 500n 1u)" savecurrent=false}
...
* PFD_tb_lag : phase-LAG case, REF rising edge 100ns AFTER FB (same freq).
* Project rail 3.3V. Stimulus first edges at 50ns so edge detectors are armed
* under uic (Rule 7). Expect wide DOWN pulses, UP = reset pulse only.
