...
C {vsource.sym} -450 120 0 0 {name=V_FB value="PULSE(0 3.3 50n 100p 100p 500n 1u)" savecurrent=false}
...
* PFD_tb_eqfreq : equal-frequency, zero-phase (locked) case. REF and FB rise
* together at 50ns, same 1us period. Project rail 3.3V; first edges at 50ns so
* edge detectors are armed under uic (Rule 7). Expect UP = DOWN = reset pulse
* only (near-zero net pump current) - the locked condition.
