...
C {lab_pin.sym} -120 100 0 0 {name=l5 lab=GND}
...
C {lab_pin.sym} 480 40 0 0 {name=l10 lab=GND}
...
C {lab_pin.sym} 1080 100 0 0 {name=l18 lab=GND}
...
C {lab_pin.sym} 1680 160 0 0 {name=l27 lab=GND}
...
C {lab_pin.sym} 2280 20 0 0 {name=l31 lab=GND}
C {lab_pin.sym} 2280 60 0 0 {name=l32 lab=VTUNE}
C {lab_pin.sym} 2280 100 0 0 {name=l33 lab=GND}
C {ipin.sym} -200 -500 0 0 {name=P_VDDA lab=VDDA}
C {ipin.sym} -40 -500 0 0 {name=P_IBIAS lab=IBIAS}
C {ipin.sym} 120 -500 0 0 {name=P_VTUNE lab=VTUNE}
C {opin.sym} 280 -500 0 0 {name=P_CP_OUT lab=CP_OUT}
C {opin.sym} 440 -500 0 0 {name=P_I_P lab=I_P}
C {opin.sym} 600 -500 0 0 {name=P_I_N lab=I_N}
C {opin.sym} 760 -500 0 0 {name=P_Q_P lab=Q_P}
C {opin.sym} 920 -500 0 0 {name=P_Q_N lab=Q_N}
C {ipin.sym} 1080 -500 0 0 {name=P_VDDD lab=VDDD}
C {ipin.sym} 1240 -500 0 0 {name=P_REF_IN lab=REF_IN}
