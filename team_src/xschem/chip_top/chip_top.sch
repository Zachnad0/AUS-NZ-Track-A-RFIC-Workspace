...
C {ipin.sym} 120 -500 0 0 {name=P_ISS lab=ISS}
C {ipin.sym} 280 -500 0 0 {name=P_VTUNE lab=VTUNE}
C {opin.sym} 440 -500 0 0 {name=P_CP_OUT lab=CP_OUT}
C {opin.sym} 600 -500 0 0 {name=P_I_P lab=I_P}
